...
\begin{lstlisting}[caption={Claim Extractor system prompt}, label={lst:claim-prompt}]
...
\begin{lstlisting}[caption={Evidence Extractor system prompt}, label={lst:evidence-prompt}]
...
\begin{lstlisting}[caption={Verdict Generator system prompt}, label={lst:verdict-prompt}]
