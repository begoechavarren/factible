...
Evaluation on 30 annotated YouTube videos across health, climate, and political topics demonstrates strong performance: 81.3\% claim extraction precision, 94.7\% evidence retrieval success rate, and 73.0\% verdict accuracy. The system achieves practical efficiency with mean processing time of 82.2 seconds per video at \$0.003 average cost, enabling cost-effective deployment for individual users.
