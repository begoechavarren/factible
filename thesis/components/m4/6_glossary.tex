...
\item[Zero-Shot Prompting] A technique where a language model performs a task based only on the task description, without being provided examples in the prompt.
...
\item[FEVER] Fact Extraction and VERification (benchmark dataset)
...
\item[MBFC] Media Bias/Fact Check
...
\item[WHOIS] Protocol for querying domain registration information
